...
public class ChangeODBNumberDialog extends InfoDialog implements DatabaseListener, EntitySelectionListener 
{
	...
	ChangeODBNumberDialog(JFrame owner, String[] tfNames)
	{
		...
		this.setTitle("Change ODB Number");
		lblONCIcon.setText("<html><font color=blue>Enter New ODB Number<br>and Click Save</font></html>");
		...
		btnAction.setText("Save New ODB Number");
